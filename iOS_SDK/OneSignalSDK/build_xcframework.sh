...
xcodebuild archive -scheme ${BUILD_SCHEME} \
    -destination="generic/platform=iOS Simulator" -arch i386 -arch x86_64 -arch arm64 \
...
xcodebuild archive -scheme ${BUILD_SCHEME} \
    -destination='generic/platform=macOS,variant=Mac Catalyst' -arch x86_64 -arch arm64 \
